...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${service.name} | WildExit Animal Control`,
      description: service.description,
  ...
  return (
    <>
            ...
            <Reveal delay={0.05}>
              <div className="glass-card rounded-3xl p-7">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Every property is different. We inspect, identify entry points and give you a
            ...
            <Reveal delay={0.1}>
              <div className="glass-card rounded-3xl p-7">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  We serve 12 counties — suburban homes, farms, storefronts, warehouses and
                  multi-unit buildings. Emergency crews cover the full region 24/7.
                </p>
              </div>
            </Reveal>
          </div>
      ...
      <CtaBand
        ...
        subtitle="Tell us about your property and we will respond within one business day with a firm, written quote — and in hours for emergencies."
      />
    </>
  );
}
