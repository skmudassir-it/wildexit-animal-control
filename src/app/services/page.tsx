...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Raccoon removal, squirrel exclusion, bat removal, bird control, rodent proofing, attic restoration and 24/7 emergency wildlife response — all humane, all guaranteed.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="One crew for every wildlife problem"
            subtitle="Seven services covering removal, exclusion and restoration — humane methods, firm quotes and a 5-year guarantee."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-6xl">
          ...
          <Reveal className="mt-14 text-center">
            ...
            >
              Talk to a wildlife expert <ArrowRight className="size-4" />
            </Link>
          </Reveal>
        </div>
      </section>
