...
export function CtaBand({
  title = "Ready for a quiet, wildlife-free home?",
  subtitle = "Get a free, no-obligation quote. Our crew responds within one business day — and in 60–90 minutes for emergencies.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="A sealed, restored attic with fresh insulation"
              fill
              sizes="100vw"
